...
```
### Other
Download `gdrive` from one of the [links in the latest release](https://github.com/masterofthesith/gdrive/releases).
...
## Compile from source
```bash
go install github.com/masterofthesith/gdrive@latest
```
